...
def obtenir_courbe_temperature_jour(temps, temperatures):
    ...
    nf_min = "minima_temperature_jour.png"
    ...
    nf_max = "maxima_temperature_jour.png"
    ...
    nf_moy = "moyennes_temperature_jour.png"
...
def obtenir_courbe_temperature_mois(temps, temperatures, annee, mois):
    ...
    jours.sort()
    nf_min = "minima_temperature_mois.png"
    ...
    nf_max = "maxima_temperature_mois.png"
    ...
    nf_moy = "moyennes_temperature_mois.png"
...
def obtenir_courbe_temperature_annee(temps, temperatures, annee):
    # jour en datetime.datetime.now()
    nf_min = "nom_temperature_annee_minima.png"
    ...
    nf_max = "nom_temperature_annee_maxima.png"
    ...
    nf_moy = "nom_temperature_annee_moyennes.png"
...
def obtenir_courbe_humidite_jour(temps, humidites):
    ...
    jour = temps[0]
    jour_semaine = jour.ctime()[:3]
    nf_min = "minima_humidite_jour.png"
    ...
    nf_max = "maxima_humidite_jour.png"
    ...
    nf_moy = "moyennes_humidite_jour.png"
...
def obtenir_courbe_humidite_mois(temps, humidites, annee, mois):
    ...
    jours = list(set([jour.day for jour in temps]))
    jours.sort()
    nf_min = "minima_humidite_mois.png"
    ...
    nf_max = "maxima_humidite_mois.png"
    ...
    nf_moy = "moyennes_humidite_mois.png"
...
def obtenir_courbe_humidite_annee(temps, humidites, annee):
    ...
    nf_min = "nom_humidite_annee_minima.png"
    nom_minima = os.path.join(DIRECTORY, nf_min)
    ...
    nf_max = "nom_humidite_annee_maxima.png"
    nom_maxima = os.path.join(DIRECTORY, nf_max)
    ...
    nf_moy = "nom_humidite_annee_moyennes.png"
    nom_moyennes = os.path.join(DIRECTORY, nf_moy)
